...
import { AnalyticsQueryParams, IAnalyticsResponse } from "./types";
...
describe("AppController", () => {
    ...
    beforeAll(async () => {
        ...
        process.env.DATABASE_CONNECTION_STRING="postgres://postgres:mysecretpassword@localhost:5432/authory"
